...
// Загрузка текущего счета из вашей системы
let currentRowScore = gameState.rowscore || 0;
...
function addRow(amount) {
    currentRowScore += amount;
    gameState.rowscore = currentRowScore; // Обновляем глобальное состояние
    updateRankSystem();
}
